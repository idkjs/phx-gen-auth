defmodule TutorialAuthWeb.UserAuthTest do
  use TutorialAuthWeb.ConnCase, async: true

  alias TutorialAuth.Accounts
  alias TutorialAuthWeb.UserAuth
  import TutorialAuth.AccountsFixtures
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TutorialAuthWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TutorialAuthWeb.Endpoint.subscribe(live_socket_id)
